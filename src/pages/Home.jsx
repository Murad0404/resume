...
const Home = () => {
  ...
  const homeProjects = [
    { id: 8,  tag: 'WEB & DESIGN',   title: 'Biorganic',            desc: 'E-Commerce Website',     link: '/projects', img: biorganicImg, bgColor: '#66a136', imgStyle: { objectFit: 'contain', padding: '10%', transform: 'scale(1.05)' } },
